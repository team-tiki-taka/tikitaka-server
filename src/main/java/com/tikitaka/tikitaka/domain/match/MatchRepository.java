...
public interface MatchRepository extends JpaRepository<Match, Long> {
    ...
    @Query("SELECT m " +
            ...
            "JOIN m.toMember t " +
            "WHERE t = :member " +
            "AND m.status <> com.tikitaka.tikitaka.domain.match.constant.MatchStatus.ACCEPTED " +
            "AND m.status <> com.tikitaka.tikitaka.domain.match.constant.MatchStatus.OPEN")
    ...
    @Query("SELECT m " +
            ...
            "AND (m.status = com.tikitaka.tikitaka.domain.match.constant.MatchStatus.ACCEPTED " +
            "OR m.status = com.tikitaka.tikitaka.domain.match.constant.MatchStatus.OPEN)")
